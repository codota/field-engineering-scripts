...
# a773a0f9-ed11-4a5c-9f5c-729be13b3026    Devstral 2"
...
models=( 
  ...
  "a773a0f9-ed11-4a5c-9f5c-729be13b3026"
...
function show_help() {
  ...
  echo -e "          Claude 4.6 Opus            7"
  echo -e "          Claude 4.6 Sonnet          8"
  echo -e "          Codestral                  9"
  echo -e "          DeepSeek                   10"
  echo -e "          Devstral 2                 11"
  echo -e "          Devstral 24B               12"
  echo -e "          Gemini 2.0 Flash           13"
  echo -e "          Gemini 2.5 Flash           14"
  echo -e "          Gemini 2.5 Pro             15"
  echo -e "          Gemini 3 Pro               16"
  echo -e "          Gemma 3 27B                17"
  echo -e "          GLM 4.7                    18"
  echo -e "          GPT-4                      19"
  echo -e "          GPT-4.1                    20"
  echo -e "          GPT-4o                     21"
  echo -e "          GPT-4o mini                22"
  echo -e "          GPT-5                      23"
  echo -e "          GPT-5.2                    24"
